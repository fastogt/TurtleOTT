...
import 'package:turtleott/pages/home/home_mobile.dart';
...
class _AppRootState extends State<MobileAppRoot> {
  late AppBloc _bloc;
  ...
  Widget _root(BuildContext context, AppState? state) {
    if (state is AuthenticatedAppState) {
      ...
      return AppConfig(
          buildType: AppConfig.of(context).buildType, wsMode: mode, child: HomeMobile(profile));
    }
